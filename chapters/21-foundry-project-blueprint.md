# Chapter 21 — Lab: Foundry Project Blueprint & Provisioning

## Objective

> **This is a hands-on lab.** You will manually build each component to understand how enterprise Foundry project provisioning works under the hood. For the fully automated, zero-manual self-service portal, see [Chapter 21a — Self-Service Portal](./21a-self-service-portal.md).
...
- For the **fully automated self-service portal** (zero manual steps, UX-based approval workflows), proceed to [Chapter 21a — Self-Service Portal](./21a-self-service-portal.md)
- For identity and guardrails configuration, proceed to [Chapter 22 — Identity, RBAC & Guardrails by Default](./22-identity-rbac-guardrails.md)
